...
# Zones d'interet (support hebdomadaire fort, DCA dynamique)
ZONE_WEEKLY_WINDOW = 4
ZONE_TOLERANCE_PCT = 0.03
ZONE_MIN_TOUCHES = 2
ZONE_ATH_MIN_DRAWDOWN_PCT = 0.20

# Doubles tops/bottoms (figures chartistes)
CHART_PATTERN_WINDOW = 10
CHART_PATTERN_TOLERANCE_PCT = 0.03
CHART_PATTERN_MIN_DEPTH_PCT = 0.03
